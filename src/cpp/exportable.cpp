...
Hdf5Exportable::save_hdf5(py::object hdf5_saver, py::object h5gr, std::string subpath)
{
    ...
    py::object type_repr = hdf5_saver.attr("save_dict_content")(self.attr("__dict__"), h5gr, subpath);
    h5_set_attr(h5gr, ATTR_FORMAT, type_repr);
}

py::object
Hdf5Exportable::from_hdf5(py::type cls, py::object hdf5_loader, py::object h5gr, std::string subpath)
{
